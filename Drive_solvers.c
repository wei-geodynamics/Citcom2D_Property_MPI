...
//        fprintf(stderr, "finish delta_U %d \n", E->parallel.me);
...
//        fprintf(stderr, "finish velo conform%d \n", E->parallel.me);
  assemble_forces(E, 0);
//        fprintf(stderr, "finish assemble force %d \n", E->parallel.me);
  /*	
	if(E->parallel.me==0)
	{
...
//        fprintf(stderr, "finish viscosity %d \n", E->parallel.me);

    construct_stiffness_B_matrix(E);

//        fprintf(stderr, "finishB %d \n", E->parallel.me);

    solve_constrained_flow_iterative(E);
//        fprintf(stderr, "finish flow %d \n", E->parallel.me);
